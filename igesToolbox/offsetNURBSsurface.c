 ...
 *
 * compile in Matlab by using the command  "mex offsetNURBSsurface.c"
 *
 * See "help mex" for more information
 *
 * written by Per Bergström 2020-10-26
 *
 **************************************************************************/
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    int orderUoff, orderVoff, ncpOff, kcpOff, orderUorg, orderVorg, ncpOrg, kcpOrg, noffp, nunkn, norgp, intTmp;
    ...
    if (nlhs==3 && nrhs==4){
        ...
        dims[0]=(mwSize)3;
        dims[1]=(mwSize)ncpOff;
        dims[2]=(mwSize)kcpOff;
