    ...
    if (nrhs==7){
        ...
        if(nlhs>1){
            ...
            if(nlhs>2){
                ...
                triDomain = mxCreateNumericMatrix((mwSize)mtri, 3, mxUINT32_CLASS, mxREAL);
                ptri = (unsigned int*)mxGetPr(triDomain);
        ...
        if(nlhs>1){
            ...
            triIIDomain = mxCreateNumericMatrix((mwSize)mtri, 3, mxUINT32_CLASS, mxREAL);
            ptri = (unsigned int*)mxGetPr(triDomain);
